...
export const filterAlertsByTab = (alerts: LiveReportAlert[], tab: TabType): LiveReportAlert[] => {
  switch (tab) {
    case "all":
      return alerts
    case "unassigned":
...
export const filterAlertsBySearch = (alerts: LiveReportAlert[], searchQuery: string): LiveReportAlert[] => {
...
export const filterAlertsByType = (alerts: LiveReportAlert[], alertType: string): LiveReportAlert[] => {
  if (alertType === "All") return alerts
  return alerts.filter(alert => alert.alertType === alertType)
}

export const applyAllFilters = (alerts: LiveReportAlert[], filters: AlertFilter): LiveReportAlert[] => {
