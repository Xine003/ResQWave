      ...
      >
        <SheetHeader className="px-6 py-4 border-b border-[#2a2a2a]">
          <div className="flex items-center justify-between">
            <SheetTitle className="text-white text-xl font-medium">Terminal Information</SheetTitle>
          </div>
        </SheetHeader>
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className={`text-sm font-semibold ${terminalData.status === 'Online' ? 'text-green-400' : 'text-red-400'}`}>
                {terminalData.status}
              </span>
            </div>
            <div className="border-t border-[#2a2a2a]"></div>
            <div className="flex justify-between items-center">
              <span className="text-white text-sm pl-3 font-bold">AVAILABILITY</span>
              <span className={`text-sm font-semibold ${terminalData.availability === 'Available' ? 'text-blue-400' : 'text-yellow-400'}`}>
                {terminalData.availability}
              </span>
            </div>
            <div className="border-t border-[#2a2a2a]"></div>
            <div className="flex justify-between items-center">
              <span className="text-white text-sm pl-3 font-bold">CREATED DATE</span>
              <span className="text-white text-sm">{terminalData.dateCreated}</span>
            </div>
            <div className="border-t border-[#2a2a2a]"></div>
            <div className="flex justify-between items-center">
              <span className="text-white text-sm pl-3 font-bold">UPDATED DATE</span>
              <span className="text-white text-sm">{terminalData.dateUpdated}</span>
            </div>
            {terminalData.archived !== undefined && (
              <>
                <div className="border-t border-[#2a2a2a]"></div>
                <div className="flex justify-between items-center">
                  <span className="text-white text-sm pl-3 font-bold">ARCHIVED</span>
                  <span className={`text-sm font-semibold ${terminalData.archived ? 'text-orange-400' : 'text-green-400'}`}>
