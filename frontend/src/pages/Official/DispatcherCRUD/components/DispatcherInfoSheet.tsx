      ...
      >
        <SheetHeader className="px-6 py-4 border-b border-[#2a2a2a]">
          <div className="flex items-center justify-between">
            <SheetTitle className="text-white text-xl font-medium">Dispatcher Information</SheetTitle>
          </div>
        </SheetHeader>
        ...
        <div className="px-6 py-6 space-y-6">
          ...
          <div className="space-y-4">
            <div className="bg-[#0b0b0b] rounded-[6px] flex justify-center mt-1">
              <div className="relative w-full max-w-full h-40 rounded-[8px] overflow-hidden bg-[#111] flex items-center justify-center">
                <CircleUserRound className="w-24 h-24 text-[#a1a1a1]" strokeWidth={1.5} />
          ...
          <div className="space-y-4">
            ...
            <div className="border-t border-[#2a2a2a]"></div>
            <div className="flex justify-between items-center">
              <span className="text-white text-sm pl-3 font-bold">FULL NAME</span>
              <span className="text-white text-sm">{dispatcherData.name}</span>
            </div>
            <div className="border-t border-[#2a2a2a]"></div>
            <div className="flex justify-between items-center">
              <span className="text-white text-sm pl-3 font-bold">CONTACT NUMBER</span>
              <span className="text-white text-sm">{dispatcherData.contactNumber}</span>
            </div>
            <div className="border-t border-[#2a2a2a]"></div>
            <div className="flex justify-between items-center">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-white text-sm">{dispatcherData.createdAt}</span>
            </div>
            {dispatcherData.createdBy && (
              <>
                <div className="border-t border-[#2a2a2a]"></div>
                <div className="flex justify-between items-center">
                  <span className="text-white text-sm pl-3 font-bold">CREATED BY</span>
                  <span className="text-white text-sm">{dispatcherData.createdBy}</span>
                </div>
              </>
            )}
          </div>
