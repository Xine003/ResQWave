            ...
            <div className="flex-1 overflow-y-auto px-6 pb-24 h-[calc(100vh-160px)]">
                ...
                <div className="mb-6">
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="relative">
                                ...
                                <div className="absolute right-2 top-1/2 transform -translate-y-1/2">
                                    <div className="flex flex-col">
                                        ...
                                        <button 
                                            type="button"
                                            onClick={() => setPersonnelDeployed(prev => Math.max(0, prev - 1))}
                                            className="text-gray-400 hover:text-gray-300 text-xs leading-none"
                                        >
                                            ▼
                                        </button>
                        ...
                        {/* Resources Used */}
                        <div>
                            <label className="block text-white font-medium text-sm mb-2">2. Resources Used</label>
                        ...
                        {/* Actions Taken */}
                        <div>
                            <label className="block text-white font-medium text-sm mb-2">3. Actions Taken</label>
