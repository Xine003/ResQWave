...
import { Layers, Minus, PanelRight, Plus } from 'lucide-react';
        ...
        <>
                        ...
                        <TooltipTrigger asChild>
                            <div
                                style={{
                                    ...
                                    cursor: 'pointer',
                                    boxShadow: isLiveReportOpen ? '0 6px 16px rgba(0,0,0,0.35)' : '0 4px 12px rgba(2,6,23,0.21)',
                                    transition: 'all 0.3s ease'
                                }}
                                onMouseEnter={e => { 
                                    if (!isLiveReportOpen) e.currentTarget.style.background = '#EEEEEE' 
                                }}
                                onMouseLeave={e => { 
                                    e.currentTarget.style.background = isLiveReportOpen ? '#111827' : '#fff'
                                }}
                                onClick={onToggleLiveReport}
                            >
                                <button aria-label="Live Report" style={{ background: 'transparent', border: 'none', color: isLiveReportOpen ? '#fff' : '#000', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    <PanelRight size={21} />
                                </button>
                            </div>
                        </TooltipTrigger>
            ...
            <div style={{ position: 'absolute', right: 21, bottom: 21, zIndex: 40, display: 'flex', flexDirection: 'column', gap: 11 }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <div style={{ width: 50, borderTopLeftRadius: 7, borderTopRightRadius: 7, borderBottomLeftRadius: 0, borderBottomRightRadius: 0, overflow: 'hidden', background: '#fff', boxShadow: '0 4px 12px rgba(2,6,23,0.21)', display: 'flex', flexDirection: 'column' }}>
                                <button
                                    aria-label="Zoom in"
