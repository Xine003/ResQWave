...
export default function LiveReportSidebar({ isOpen, onClose, signals, onCardClick }: LiveReportSidebarProps) {
    ...
    const renderAlerts = (alerts: Signal[]) => {
        ...
        return alerts.map((signal, index) => renderAlertCard(signal, index));
    };
    ...
    return (
        ...
        >
            ...
            {/* Content Area */}
            <div className="flex-1 overflow-y-auto px-4 pb-4" style={{ height: 'calc(100vh - 200px)' }}>
