...
export default forwardRef<RescueFormAlertsHandle, {}>(function RescueFormAlerts(_props, ref) {
	...
	useImperativeHandle(ref, () => ({
		showWaitlistSuccess: (focalPerson: string) => {
			hideAllAlerts()
			setWaitlistMessage(`Rescue form for "${focalPerson}" added to waitlist!`)
					...
					<div className="bg-[#171717] border border-[#2a2a2a] rounded-[5px] p-6 max-w-md w-full mx-4 shadow-xl">
						<div className="flex items-start gap-4">
							...
							<div className="flex-1">
								<h3 className="text-lg font-semibold text-white mb-2">Dispatch Rescue Team</h3>
								<p className="text-[14px] text-[#a1a1a1] mb-1">
									Are you sure you want to dispatch a rescue team for <span className="text-white font-semibold">{dispatchConfirmData.focalPerson}</span>?
								</p>
