...
export function ResetPassword({ userID, code, onSuccess, onBack, onError }: ResetPasswordProps) {
    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            Protect your account with a strong unique password. We<br />
        ...
        >
              ...
              <ul className="space-y-1">
                ...
                {confirmPassword.length > 0 && (
                  <li className="flex items-center gap-2 text-sm mt-1">
                    ...
                    <span className={passwordsMatch ? 'text-green-500' : 'text-gray-400'}>
                      Passwords match
                    </span>
                  </li>
                )}
          ...
          <Button
            ...
            style={{
              opacity: isLoading || !allRequirementsMet || !passwordsMatch ? 0.7 : 1,
              width: '100%',
