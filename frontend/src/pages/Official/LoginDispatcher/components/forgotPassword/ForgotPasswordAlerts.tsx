...
export default forwardRef<ForgotPasswordAlertsHandle>(function ForgotPasswordAlerts(_props, ref) {
	...
	useEffect(() => {
		return () => {
			...
			if (codeVerifiedTimer.current) window.clearTimeout(codeVerifiedTimer.current)
			if (codeResentTimer.current) window.clearTimeout(codeResentTimer.current)
			if (passwordUpdatedTimer.current) window.clearTimeout(passwordUpdatedTimer.current)
	...
	return (
		<>
			{/* Code Sent Alert - Bottom Left */}
			<div className={`fixed left-[30px] bottom-[30px] z-[100] transition-all duration-300 ease-out ${showCodeSent ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0 pointer-events-none"}`}>
			...
			{/* Code Verified Alert - Bottom Left */}
			<div className={`fixed left-[30px] bottom-[30px] z-[100] transition-all duration-300 ease-out ${showCodeVerified ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0 pointer-events-none"}`}>
				<Alert className="min-w-[280px] max-w-[520px] bg-[#171717] border border-[#2a2a2a] text-white rounded-[5px] !items-center !grid-cols-[auto_1fr] !gap-x-3">
			...
			{/* Code Resent Alert - Bottom Left */}
			<div className={`fixed left-[30px] bottom-[30px] z-[100] transition-all duration-300 ease-out ${showCodeResent ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0 pointer-events-none"}`}>
				<Alert className="min-w-[280px] max-w-[520px] bg-[#171717] border border-[#2a2a2a] text-white rounded-[5px] !items-center !grid-cols-[auto_1fr] !gap-x-3">
					<div className="flex h-12 w-12 items-center justify-center rounded-[5px] bg-blue-600/25">
						<Mail className="size-5 text-[#3B82F6]" />
					</div>
			...
			{/* Password Updated Alert - Bottom Left */}
			<div className={`fixed left-[30px] bottom-[30px] z-[100] transition-all duration-300 ease-out ${showPasswordUpdated ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0 pointer-events-none"}`}>
				<Alert className="min-w-[280px] max-w-[520px] bg-[#171717] border border-[#2a2a2a] text-white rounded-[5px] !items-center !grid-cols-[auto_1fr] !gap-x-3">
					<div className="flex h-12 w-12 items-center justify-center rounded-[5px] bg-green-600/25">
			...
			{/* Error Alert - Bottom Left */}
			<div className={`fixed left-[30px] bottom-[30px] z-[100] transition-all duration-300 ease-out ${showError ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0 pointer-events-none"}`}>
