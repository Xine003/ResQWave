...
export default function AccountReview() {
  ...
  return (
    <div className="min-h-screen flex flex-col primary-background" style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      <FocalHeader />
      <main className="flex flex-1 flex-col items-center w-full" style={{ zIndex: 20, position: 'relative', marginTop: '120px' }}>
  <div className="flex flex-col items-center justify-center w-full max-w-lg">
          ...
          <p className="text-gray-300 text-center text-[17px] max-w-xl leading-relaxed mb-9">
            For inquiries or more information, visit <a href="https://help.resqwave.com" className="text-blue-400 hover:text-blue-500 underline">ResQWave Help Center</a>.
          </p>
          <button
