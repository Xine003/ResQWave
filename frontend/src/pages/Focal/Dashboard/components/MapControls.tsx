...
export default function MapControls({ mapRef, mapLoaded, makeTooltip, addCustomLayers, editBoundaryOpen, handleDeleteBoundary }: MapControlsProps) {
    ...
    return (
        <div style={{ position: 'absolute', right: 21, bottom: 21, zIndex: 40, display: 'flex', flexDirection: 'column', gap: 11 }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
                <Tooltip content={layersOpen ? undefined : makeTooltip('Layers')} side="left">
